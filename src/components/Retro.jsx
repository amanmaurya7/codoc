...
export function RetroGridDemo() {
  return (
    <div className="relative flex h-[100vh] w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background ">
      <WordRotateDemo/>
      ...
      <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 mt-5 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
              <Link href={"/dashboard"}>
